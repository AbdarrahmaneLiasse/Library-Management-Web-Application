<%@ Page Language="C#" Theme="MeslivresAdmin" AutoEventWireup="true" CodeBehind="MeslivresAdmin.aspx.cs" Inherits="WebApplication1.Client.MeslivresAdmin" %>
            ...
            <div id="nav">
               <ul>
                   <li><a href="#">
                    ...
                    <li><a href="#"><asp:LinkButton ID="LinkButton5" runat="server" OnClick="LinkButton5_Click">Panier</asp:LinkButton></a></li>
