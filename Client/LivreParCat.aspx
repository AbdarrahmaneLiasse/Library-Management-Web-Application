<%@ Page Theme="LivreParCat" Language="C#" AutoEventWireup="true" CodeBehind="LivreParCat.aspx.cs" Inherits="WebApplication1.Client.LivreParCat" %>
...
<body>
    ...
    <header>
        <div id="container">
            ...
            <div id="button">
                    <asp:LinkButton ID="LinkButton7" CssClass="a" runat="server" OnClick="LinkButton7_Click">Se déconnecter</asp:LinkButton>    
            </div>
        </div>
      </header>
      <main>
