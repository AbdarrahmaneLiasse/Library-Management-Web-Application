<%@ Page Language="C#" Theme="panier" AutoEventWireup="true" CodeBehind="panier.aspx.cs" Inherits="WebApplication1.Client.panier" %>
            ...
            <tr>
              ...
              <asp:Label ID="titre" runat="server" Text='<%# Eval("titre") %>'></asp:Label>     
                ...
                <td style="text-align:center ;">
                        ...
                        <asp:Label ID="Label3" CssClass="spanqte" runat="server" Text='<%# Eval("qte") %>'></asp:Label>
                ...
                <td style="text-align: center;">
                   <a href=""><asp:LinkButton CssClass="BTNSUPPRIMER" OnClick="BtnSuppr_ServerClick" ID="BtnSuppr" runat="server">X</asp:LinkButton></a> 
                </td>
            </tr>
                  </ItemTemplate>
            </asp:ListView>
